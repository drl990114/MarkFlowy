...
function isSelectSettingItem(item: Setting.SettingItem): item is Setting.SelectSettingItem {
  return item.type === 'select'
}

function isInputSettingItem(item: Setting.SettingItem): item is Setting.InputSettingItem {
