  ...
  return (
    <>
      <SettingGroupContainer $anchorId={getSettingGroupAnchorId('image', 'paste_event')}>
        <h2 className='setting-group__title'>{t('settings.image.paste_event.label')}</h2>
          ...
          {settingData.when_paste_image === 'save_to_local_relative' ? (
            <InputSettingItem
              item={{
                ...
                type: 'input',
                title: {
                  i18nKey: 'settings.image.paste_event.paste_image_save_relative_path.label',
                },
          ...
          {settingData.when_paste_image === 'save_to_local_absolute' ? (
            <PathSelectSettingItem
              item={{
                ...
                type: 'path_select',
                title: {
                  i18nKey: 'settings.image.paste_event.paste_image_save_absolute_path.label',
                },
      ...
      <SettingGroupContainer $anchorId={getSettingGroupAnchorId('image', 'upload_img')}>
        <h2 className='setting-group__title'>{t('settings.image.upload_img.label')}</h2>
        <div className='setting-group__items'>
          <SelectSettingItem
            item={{
          ...
          {settingData.when_upload_image === 'save_to_local_relative' ? (
            <InputSettingItem
              item={{
                ...
                type: 'input',
                title: {
                  i18nKey: 'settings.image.upload_img.upload_image_save_relative_path.label',
                },
          ...
          {settingData.when_upload_image === 'save_to_local_absolute' ? (
            <PathSelectSettingItem
              item={{
                ...
                type: 'path_select',
                title: {
                  i18nKey: 'settings.image.upload_img.upload_image_save_absolute_path.label',
                },
