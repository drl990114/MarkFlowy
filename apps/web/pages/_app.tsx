    ...
    return (
      <>
        <Head>
          ...
          <link
            href='https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@200;400;700&display=swap'
            rel='stylesheet'
          ></link>
        </Head>
