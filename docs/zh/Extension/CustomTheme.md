...
MarkFlowy 已集成 `@drl990114/capricorn-runtime@0.3.1`，沿用 0.3.0 引入的主题契约，由 `scripts/install-capricorn-runtime.mjs` 和 `apps/desktop/capricornRuntimeResolver.ts` 固定精确版本。安装器校验正式 tarball 的 SHA-256 和包身份。
