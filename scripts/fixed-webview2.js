...
async function resolvePortable() {
  ...
  const releaseDir = target
    ? `./apps/desktop/src-tauri/target/${target}/release`
  ...
  zip.addLocalFile(path.join(releaseDir, "MarkFlowy.exe"));
  ...
  const zipFile = `MarkFlowy_${version}_${arch}_fixed_webview2_portable.zip`;
